use quote::ToTokens;
use syn::{parse::ParseStream, spanned::Spanned, Attribute, LitInt, Meta, Token};

use crate::{
    parse::name_value::parse_name_value_literal, ParsingError, ACCOUNT_NAME, ACCOUNT_SIGNER,
    ACCOUNT_WRITABLE, DESCRIPTION,
};
